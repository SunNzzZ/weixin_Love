...
def caihongpi():
    APIKEY = '60f429740639b9c63f9c3d72ef3307ca'
...
def send_message(to_user, access_token, region_name, weather, tempMin, tempMax, wind_dir, pipi, xuanyan):
...
if __name__ == "__main__":
    ...
    # 公众号推送消息
    for user in users:
        send_message(user, accessToken, region, weather, tempMin, tempMax, wind_dir, pipi, xuanyan)
    os.system("pause")